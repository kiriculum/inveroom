# Generated by Django 4.2.4 on 2023-08-22 02:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(blank=True, default='', max_length=256, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(blank=True, default='', max_length=256, verbose_name='name')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='schools.location')),
            ],
            options={
                'verbose_name': 'Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(blank=True, default='', max_length=256, verbose_name='name')),
                ('components', models.ManyToManyField(blank=True, related_name='templates', to='schools.componentvariant', verbose_name='Components')),
                ('expendables', models.ManyToManyField(blank=True, related_name='templates', to='schools.expendable', verbose_name='Expendables')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expendables', models.ManyToManyField(blank=True, related_name='devices', to='schools.expendable', verbose_name='Expendables')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='components', to='schools.componentvariant')),
            ],
            options={
